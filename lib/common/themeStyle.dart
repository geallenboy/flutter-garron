...
class ThemeStyle {
  ...
  static EdgeInsets paddingBox = EdgeInsets.only(
      left: ThemeSize.containerPadding, right: ThemeSize.containerPadding);
  ...
  //列边距
  static EdgeInsets columnPadding = EdgeInsets.only(
      top: ThemeSize.columnPadding, bottom: ThemeSize.columnPadding);
}
